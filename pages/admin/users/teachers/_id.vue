        ...
        <div>Дисциплины:
          <table class="table table-striped table-sm">
            ...
            <tr v-for="userDiscipline in user.disciplines">
              ...
              <td><button @click="removeDiscipline(userDiscipline.id)" class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-minus" viewBox="0 0 16 16">
