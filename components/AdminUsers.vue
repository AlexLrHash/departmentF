...
export default {
  ...
  methods: {
    ...
    async deleteUser() {
      const response = await fetch(`http://localhost:8000/api/admin/users/delete/${this.userId}`, {
        headers: {
          'Content-Type': "application/json",
          'Accept': "application/json",
          'Authorization': "Bearer " + localStorage.getItem('jwt')
    ...
    async updateUser()
    {
      const response = await fetch(`http://localhost:8000/api/admin/users/update/${this.userId}`, {
        headers: {
          'Content-Type': "application/json",
          'Accept': "application/json",
          'Authorization': "Bearer " + localStorage.getItem('jwt')
