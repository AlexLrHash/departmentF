...
export default {
  ...
  methods: {
    ...
    async createDepartment() {
      const response = await fetch(`http://localhost:8000/api/admin/departments/create`, {
        headers: {
          'Content-Type': 'application/json',
          "Accept": "application/json",
          'Authorization': "Bearer " + localStorage.getItem('jwt')
    ...
    async deleteDepartment() {
      const response = await fetch(`http://localhost:8000/api/admin/departments/delete/${this.departmentId}`, {
        headers: {
          'Content-Type': 'application/json',
          "Accept": "application/json",
          'Authorization': "Bearer " + localStorage.getItem('jwt')
    ...
    async updateDepartment() {
        const response = await fetch(`http://localhost:8000/api/admin/departments/update/${this.departmentId}`, {
          headers: {
            'Content-Type': 'application/json',
            "Accept": "application/json",
            'Authorization': "Bearer " + localStorage.getItem('jwt')
